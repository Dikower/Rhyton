...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		<h2 class="h2 font-bold text-4xl italic">Meet the <b class="font-black">Rhyton.</b></h2>
		<p>Modern and rapid Python to R transpiler</p>
		<!-- Animated Logo -->
		<figure>
		...
		<div class="flex justify-center space-x-2">
			<a class="btn variant-filled bg-primary-500" href="https://github.com/Dikower/Rhyton" target="_blank" rel="noreferrer">
				<Fa icon={faGithub} class="mr-2"/>
				GitHub
			</a>
			<a class="btn variant-filled bg-secondary-500 disabled" href="https://pypi.org/project/rhyton/" target="_blank" rel="noreferrer">
				<Fa icon={faPython} class="mr-2"/>
				PyPi
			</a>
		</div>
		<a class="btn variant-filled bg-slate-500 text-slate-400" target="_blank" rel="noreferrer">
			<Fa icon={faCloud} class="mr-2"/>
			Online Demo
		</a>
		</div>
	</div>
